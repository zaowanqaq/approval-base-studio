...
export class PaymentConfig {
  ...
  readonly oauthRedirectUri = optional('FEISHU_OAUTH_REDIRECT_URI');
  readonly clientBasePath = optional('CLIENT_BASE_PATH').replace(/\/$/, '');
  readonly corporateApprovalLink = optional('PROJECT_APPROVAL_LINK')
  ...
  readonly walletApprovalLink = optional('WALLET_APPROVAL_LINK')
  ...
  readonly cloudApprovalLink = optional('CLOUD_APPROVAL_LINK')
  ...
  readonly cloudSingleApprovalLink = optional('CLOUD_SINGLE_APPROVAL_LINK')
